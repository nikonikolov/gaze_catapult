...
//  
//  Running on Windows 7 lb3314@EEWS104A-019 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {./edge.h} -type CHEADER
solution file add {./edge.c} -type C++
...
directive set -DESIGN_HIERARCHY edge
go compile
directive set /edge/core/ACC1 -UNROLL yes
directive set /edge/core/SHIFT -UNROLL yes
directive set /edge/core/main -DISTRIBUTED_PIPELINE true
directive set /edge/core/main -PIPELINE_INIT_INTERVAL 1
directive set /edge/vout -STREAM 30
directive set /edge/vin -STREAM 90
directive set /edge/core/ACC2 -UNROLL yes
go architect
go extract
