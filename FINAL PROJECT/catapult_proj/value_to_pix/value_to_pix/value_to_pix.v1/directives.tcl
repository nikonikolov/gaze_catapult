...
//  
project new
solution file add {./value_to_pix.h} -type CHEADER
solution file add {./value_to_pix.c} -type C++
...
directive set -DESIGN_HIERARCHY value_to_pix
go compile
directive set /detect_skin/core/main -PIPELINE_INIT_INTERVAL 1
directive set /detect_skin/pixout -STREAM 30
directive set /detect_skin/vin -STREAM 1
directive set /value_to_pix/core/main -PIPELINE_INIT_INTERVAL 1
directive set /value_to_pix/pixout -STREAM 30
directive set /value_to_pix/vin -STREAM 1
go architect
go extract
