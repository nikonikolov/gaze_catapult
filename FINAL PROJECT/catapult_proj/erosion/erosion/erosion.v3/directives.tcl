...
//  
//  Running on Windows 7 nn1114@EEWS304-032 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {./erosion.h} -type CHEADER
solution file add {./erosion.c} -type C++
...
directive set -DESIGN_HIERARCHY erosion
go compile
directive set /erosion/core/ACC1:for -PIPELINE_INIT_INTERVAL 1
directive set /erosion/core/ACC1 -PIPELINE_INIT_INTERVAL 1
directive set /erosion/core/FRAME -DISTRIBUTED_PIPELINE true
directive set /erosion/core/FRAME -PIPELINE_INIT_INTERVAL 1
directive set /erosion/vout -STREAM 30
directive set /erosion/vin -STREAM 150
go architect
go extract
