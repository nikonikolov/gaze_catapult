...
//  
project new
solution file add {./reduce_by_5.cpp} -type C++
solution file add {./reduce_by_5.h} -type CHEADER
...
directive set -DESIGN_HIERARCHY reduce_by_5
go compile
directive set /reduce_by_5/core/ACC1 -UNROLL yes
directive set /reduce_by_5/vout -STREAM 1
directive set /reduce_by_5/clk_reg -STREAM 1
directive set /reduce_by_5/vin -STREAM 150
go architect
go extract
